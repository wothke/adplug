...
set "OPT= -s WASM=0  -s DEMANGLE_SUPPORT=0 -s VERBOSE=0 -s ASSERTIONS=0 -s FORCE_FILESYSTEM=1 -s TOTAL_MEMORY=33554432 -Wno-pointer-sign -Dstricmp=strcasecmp -DVERSION="\"2.2.1-webaudio\"" -I. -I../src/ -I../libbinio/ -Os -O3  "
